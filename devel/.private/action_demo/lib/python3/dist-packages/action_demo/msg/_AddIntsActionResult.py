...
"""autogenerated by genpy from action_demo/AddIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionResult(genpy.Message):
  ...
  _type = "action_demo/AddIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/AddIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_demo.msg.AddIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_demo.msg.AddIntsResult()
