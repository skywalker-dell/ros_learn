...
"""autogenerated by genpy from action_demo/ActionDemoActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActionDemoActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "action_demo/ActionDemoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/ActionDemoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionDemoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_demo.msg.ActionDemoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_demo.msg.ActionDemoResult()
